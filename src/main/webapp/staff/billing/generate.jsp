...
<main class="flex-grow-1 p-4">
    <div class="container mt-2">
        <h2 class="mb-4 fw-semibold text-primary">
            <i class="bi bi-person-lines-fill me-2"></i>Generate New Bill
        </h2>
        ...
        <form action="${pageContext.request.contextPath}/staff/billing/generate" method="post">
            ...
            <div class="row align-items-end mb-4">
                <div class="col-md-8">
                    <label for="accountNumber" class="form-label fw-semibold"><i class="bi bi-search me-1"></i>Search & Select Customer</label>
                    <select name="accountNumber" id="accountNumber" class="form-select shadow-sm" required>
                ...
                <div class="col-md-4 d-flex justify-content-end">
                    <a href="${pageContext.request.contextPath}/staff/customers/add" class="btn btn-primary mt-4">
            ...
            <!-- Divider -->
            <hr class="border text-primary border-2 my-4" />

            <!-- Item Filter -->
            <div class="mb-3">
                <input type="text" id="itemSearch" class="form-control shadow-sm" placeholder="Search items by name...">
            </div>

            <!-- Item Table -->
            <div class="table-responsive mb-4">
                <table class="table table-bordered table-hover align-middle text-center" id="itemTable">
                    ...
                    <c:forEach var="item" items="${itemList}">
                        <tr>
                            <td class="item-name text-start">${item.name}</td>
                            <td>${item.price}</td>
                            <td>
            ...
            <div class="sticky-generate text-end">
